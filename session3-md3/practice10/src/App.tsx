export default function App() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full bg-slate-900 rounded-2xl shadow-2xl border border-slate-800 p-8 text-center transition-all duration-300 hover:border-blue-505/50 hover:shadow-blue-500/10">
      ...
      <div className="mt-8 text-xs text-slate-600 font-inter">
        Rikkei Education â€¢ Module 3 â€¢ Session 3 â€¢ Practice 10
      </div>
    </div>
  )
}
